...
function Header() {
  ...
  useEffect(() => {
    ...
    setIsLoggedIn(window.location.href.toString().includes("sign-up"));
  }, []);
  return (
    !isLoggedIn && (
              ...
              {!user ? (
                ...
                <div className="flex items-center gap-5">
                  <div class="relative inline-flex">
                    <button
                      class="rounded-md py-2 px-4 border border-transparent text-center text-sm transition-all  "
                      type="button"
                    >
                      <ShoppingCart />
                    </button>
                    <span class="absolute top-1.5 right-2.5 grid min-h-[20px] min-w-[20px] translate-x-2/4 -translate-y-2/4 place-items-center rounded-full bg-red-600 text-xs text-white">
                      5
                    </span>
                  </div>
